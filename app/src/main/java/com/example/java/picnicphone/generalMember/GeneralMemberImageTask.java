...
/**
 * Created by Java on 2017/6/26. 取通訊錄會員照片
 */

class GeneralMemberImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "GeneralMemberImageTask";
    private final static String ACTION = "getImage";
    private final WeakReference<ImageView> imageViewWeakReference;

    GeneralMemberImageTask(ImageView imageView) {
    ...
    protected Bitmap doInBackground(Object... params) {
        ...
        String MEM_NO = String.valueOf(params[1].toString());
